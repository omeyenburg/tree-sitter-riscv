...
enum ts_symbol_identifiers {
  ...
  sym__statement = 100,
  sym__comment = 101,
  sym__directive_operand_separator = 102,
  sym_directive = 103,
  sym__macro_directive = 104,
  sym_macro_parameters = 105,
  sym__integer_directive = 106,
  sym_integer_mnemonic = 107,
  sym_integer_operands = 108,
  sym__float_directive = 109,
  sym_float_mnemonic = 110,
  sym_float_operands = 111,
  sym__float_operand = 112,
  sym__string_directive = 113,
  sym_string_mnemonic = 114,
  sym__string_operand = 115,
  sym__control_directive = 116,
  sym_control_mnemonic = 117,
  sym_control_operands = 118,
  sym__control_operand = 119,
  ...
  aux_sym__directive_operand_separator_repeat1 = 141,
  aux_sym_macro_parameters_repeat1 = 142,
  aux_sym__integer_directive_repeat1 = 143,
  aux_sym_integer_operands_repeat1 = 144,
  aux_sym_integer_operands_repeat2 = 145,
  aux_sym_float_operands_repeat1 = 146,
  aux_sym_control_operands_repeat1 = 147,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [228] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_integer_operands, 1, 0, 0), SHIFT(85),
  ...
  [597] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__directive_operand_separator_repeat1, 2, 0, 0), SHIFT_REPEAT(351),
  [600] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__directive_operand_separator_repeat1, 2, 0, 0),
  ...
  [610] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__directive_operand_separator, 1, 0, 0),
